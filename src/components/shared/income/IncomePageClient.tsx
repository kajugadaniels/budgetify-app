...
import IncomeFilterSheet, { IncomeFilters } from "./IncomeFilterSheet";
import IncomeFormSheet, { IncomeFormValues } from "./IncomeFormSheet";
...
export default function IncomePageClient({ initialIncomes }: Props) {
    ...
    const loadIncomes = useCallback(
        async (nextFilters: IncomeFilters = filters) => {
            setIsLoading(true);
            try {
